...
gulp.task('vendor', function () {
    return merge(gulp.src('./node_modules/jquery/dist/**')
        .pipe(gulp.dest(DEST + '/vendor/jquery-' + pkgs.jquery)), gulp.src('./node_modules/bootstrap/dist/fonts/**')
...
gulp.task('serve', function (cb) {
    ...
    gulp.watch('./style.less').on("change", function (f) {
        run("lessc ./style.less ./dist/style.css").exec().on("error", function (err) {
            _this.emit("end");
        });
    });
